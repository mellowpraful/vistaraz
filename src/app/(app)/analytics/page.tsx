  ...
  return (
    <div className="space-y-7 pb-16">
      ...
      <PageHeader
        ...
        badge={
          <div className="flex items-center gap-2">
            ...
            <span className="badge badge-neutral">ISO 22320 SLA Certified</span>
          </div>
        }
        actions={
          <div className="flex items-center gap-3">
            {/* Time Range Selector */}
            <div className="flex items-center gap-1 bg-slate-900/90 border border-slate-800 p-1.5 rounded-xl shadow-sm">
            ...
            >
              <Download size={14} className={downloadingReport ? "animate-bounce text-blue-400" : "text-blue-400"} />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <div className="card p-6 bg-slate-900/90 border-slate-800 hover:border-emerald-700/60 transition-all flex flex-col justify-between min-h-[160px] shadow-xl">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold uppercase tracking-wider text-slate-400">Average Response Velocity</span>
            <div className="w-9 h-9 rounded-xl bg-emerald-950/80 border border-emerald-800 flex items-center justify-center text-emerald-400 shadow-inner">
              <Timer size={18} />
            </div>
          </div>
          <div className="my-2.5">
            ...
            <div className="text-xs text-emerald-400 flex items-center gap-1.5 mt-1.5 font-semibold">
              <ArrowDownRight size={15} className="text-emerald-400 shrink-0" />
              1.6m ahead of 8.0m SLA target
            </div>
          </div>
          <div className="text-xs text-slate-400 pt-3 border-t border-slate-800 font-sans leading-relaxed">
            From initial CAD dispatch to on-scene arrival across all active emergency units.
          </div>
        </div>

        {/* KPI 2: Incident Resolution Rate */}
        <div className="card p-6 bg-slate-900/90 border-slate-800 hover:border-blue-700/60 transition-all flex flex-col justify-between min-h-[160px] shadow-xl">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold uppercase tracking-wider text-slate-400">Incident Resolution Rate</span>
            <div className="w-9 h-9 rounded-xl bg-blue-950/80 border border-blue-800 flex items-center justify-center text-blue-400 shadow-inner">
          ...
          <div className="my-2.5">
            ...
            <div className="text-xs text-slate-300 mt-1.5 font-sans font-medium">
        ...
        <div className="card p-6 bg-slate-900/90 border-slate-800 hover:border-purple-700/60 transition-all flex flex-col justify-between min-h-[160px] shadow-xl">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold uppercase tracking-wider text-slate-400">AI Dispatch Acceptance</span>
            <div className="w-9 h-9 rounded-xl bg-purple-950/80 border border-purple-800 flex items-center justify-center text-purple-400 shadow-inner">
              <Zap size={18} />
            </div>
          </div>
          <div className="my-2.5">
            ...
            <div className="text-xs text-purple-300 flex items-center gap-1.5 mt-1.5 font-sans font-semibold">
              <ArrowUpRight size={15} className="text-purple-400 shrink-0" />
              Commander approved without manual override
            </div>
          </div>
          <div className="text-xs text-slate-400 pt-3 border-t border-slate-800 font-sans leading-relaxed">
            Human-in-the-loop recommendation authorization meeting national EOC standards.
          </div>
        </div>

        {/* KPI 4: Lives Evacuated */}
        <div className="card p-6 bg-slate-900/90 border-slate-800 hover:border-amber-700/60 transition-all flex flex-col justify-between min-h-[160px] shadow-xl">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold uppercase tracking-wider text-slate-400">Citizens Evacuated / Rescued</span>
            <div className="w-9 h-9 rounded-xl bg-amber-950/80 border border-amber-800 flex items-center justify-center text-amber-400 shadow-inner">
              <Users size={18} />
            </div>
          </div>
          <div className="my-2.5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="card p-6 sm:p-7 bg-slate-900/90 border-slate-800 space-y-6 shadow-xl flex flex-col justify-between">
          <div className="space-y-3">
            <div className="flex items-center justify-between border-b border-slate-800 pb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400 font-sans">Proportional breakdown of CAD incident intake</p>
                </div>
              </div>
              <span className="text-xs font-mono font-bold bg-slate-950 text-slate-300 px-3 py-1 rounded-lg border border-slate-800">
                142 Total
              </span>
            </div>
            ...
            <div className="space-y-1.5 pt-1">
              <div className="text-xs font-mono text-slate-400 flex items-center justify-between">
                <span>Sector Inundation Profile:</span>
                <span className="text-blue-400 font-bold">Monsoon Hydrological Driver</span>
              </div>
              <div className="h-4 bg-slate-950 rounded-xl overflow-hidden flex border border-slate-800 shadow-inner">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
              {incidentTypes.map((item) => {
                ...
                return (
                  <div
                    key={item.type}
                    className="p-3.5 bg-slate-950/80 rounded-xl border border-slate-800 space-y-2 hover:border-slate-700 transition-all shadow-sm"
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2 text-slate-200 font-bold text-xs font-sans">
                        <div className={`w-6 h-6 rounded-md ${item.color}/20 flex items-center justify-center text-slate-200 shrink-0`}>
                          <Icon size={14} />
                        </div>
          ...
          <div className="flex items-center justify-between text-xs text-slate-400 font-mono pt-3 border-t border-slate-800/80">
            <span>Primary Emergency Factor: Heavy Monsoonal River Surge (30%)</span>
        ...
        <div className="card p-6 sm:p-7 bg-slate-900/90 border-slate-800 space-y-6 shadow-xl flex flex-col justify-between">
          <div className="space-y-4">
            <div className="flex items-center justify-between border-b border-slate-800 pb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400 font-sans">Benchmarking dispatch velocity against municipal mandates</p>
                </div>
              </div>
              <span className="text-xs font-mono font-bold bg-emerald-950 text-emerald-300 px-3 py-1 rounded-lg border border-emerald-800">
                All 4 Agencies Active
              </span>
            </div>
            ...
            <div className="space-y-3.5 pt-1">
              {agencyPerformance.map((ag) => (
                <div
                  key={ag.name}
                  className="p-4 bg-slate-950/80 rounded-xl border border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:border-slate-700 transition-all shadow-sm"
                >
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      <span className="font-bold text-slate-100 text-sm font-sans tracking-tight">{ag.name}</span>
                  ...
                  <div className="flex items-center gap-6 font-mono text-right shrink-0">
                    ...
                    <div>
                      ...
                      <div className="font-bold text-emerald-400 text-sm sm:text-base flex items-center justify-end gap-1">
          ...
          <div className="flex items-center justify-between text-xs text-slate-400 font-mono pt-3 border-t border-slate-800/80">
            ...
            <span>Target Response Standard: &lt;8.0 mins</span>
          </div>
        </div>
      </div>
      ...
      <div className="card p-6 sm:p-8 bg-slate-900/90 border-slate-800 space-y-6 shadow-xl">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-800 pb-4">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-amber-950 border border-amber-800 flex items-center justify-center text-amber-400 shadow-inner">
              <Activity size={18} />
            </div>
            <div>
          ...
          <div className="flex items-center gap-3 text-xs font-mono text-slate-400 bg-slate-950 px-3.5 py-1.5 rounded-xl border border-slate-800">
            <span className="font-bold uppercase text-slate-500 text-[11px] mr-1">Load Intensity:</span>
            <span className="flex items-center gap-1.5"><span className="w-3 h-3 rounded-sm bg-slate-800 border border-slate-700" /> &lt;5 Low</span>
            <span className="flex items-center gap-1.5"><span className="w-3 h-3 rounded-sm bg-blue-500" /> 5-10 Mod</span>
            <span className="flex items-center gap-1.5"><span className="w-3 h-3 rounded-sm bg-yellow-500" /> 11-20 Elev</span>
            <span className="flex items-center gap-1.5"><span className="w-3 h-3 rounded-sm bg-orange-500" /> 21-30 High</span>
            <span className="flex items-center gap-1.5"><span className="w-3 h-3 rounded-sm bg-red-500 shadow-sm shadow-red-500/50" /> 31+ Peak</span>
          </div>
        </div>

        {/* Structured Timeline Chart */}
        <div className="space-y-3 pt-2">
          <div className="grid grid-cols-12 sm:grid-cols-24 gap-1.5 items-end h-44 p-4 bg-slate-950/90 rounded-2xl border border-slate-800 shadow-inner">
            {hourlyVolume.map((item) => {
              ...
              return (
                <div key={item.hour} className="flex flex-col items-center justify-end h-full group relative">
                  ...
                  <div className="opacity-0 group-hover:opacity-100 transition-opacity absolute -top-9 z-20 pointer-events-none bg-slate-900 border border-slate-700 text-white text-[11px] font-mono px-2 py-0.5 rounded shadow-lg whitespace-nowrap">
                    {item.label}: {val} calls
                  </div>

                  <div
                    style={{ height: `${heightPct}%` }}
                    className={`w-full rounded-md ${intensity} transition-all duration-300 hover:brightness-125 cursor-pointer`}
                  />
                  <span className="text-[10px] font-mono text-slate-500 mt-2 group-hover:text-white transition-colors">
          ...
          <div className="p-4 bg-amber-950/30 border border-amber-900/60 rounded-xl flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs font-sans">
            ...
            <div className="font-mono text-red-400 font-bold text-xs bg-red-950/80 px-3 py-1 rounded-lg border border-red-800 self-start sm:self-center">
      ...
      <div className="card p-6 sm:p-8 bg-slate-900/90 border-slate-800 space-y-5 shadow-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          <div className="p-5 bg-slate-950/80 rounded-xl border border-slate-800 space-y-2">
            <div className="text-xs font-bold font-mono text-emerald-400 uppercase flex items-center gap-1.5">
              <CheckCircle size={14} /> Dispatch Velocity Benchmark
            </div>
          ...
          {/* Insight 2 */}
          <div className="p-5 bg-slate-950/80 rounded-xl border border-slate-800 space-y-2">
            <div className="text-xs font-bold font-mono text-blue-400 uppercase flex items-center gap-1.5">
              <Building2 size={14} /> Regional Health Network Routing
            </div>
            <p className="text-sm text-slate-200 font-sans leading-relaxed">
          ...
          <div className="p-5 bg-slate-950/80 rounded-xl border border-slate-800 space-y-2">
            <div className="text-xs font-bold font-mono text-purple-400 uppercase flex items-center gap-1.5">
              <FileCheck size={14} /> AI Governance & Decision Support
            </div>
            <p className="text-sm text-slate-200 font-sans leading-relaxed">
